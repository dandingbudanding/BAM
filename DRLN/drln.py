...
class Block_BlancedAttention(nn.Module):
    def __init__(self, in_channels, out_channels, group=1):
...
class DRLN_BlancedAttention(nn.Module):
    def __init__(self, args):
        super(DRLN_BlancedAttention, self).__init__()
        ...
        self.b1 = Block_BlancedAttention(chs, chs)
        self.b2 = Block_BlancedAttention(chs, chs)
        self.b3 = Block_BlancedAttention(chs, chs)
        self.b4 = Block_BlancedAttention(chs, chs)
        self.b5 = Block_BlancedAttention(chs, chs)
        self.b6 = Block_BlancedAttention(chs, chs)
        self.b7 = Block_BlancedAttention(chs, chs)
        self.b8 = Block_BlancedAttention(chs, chs)
        self.b9 = Block_BlancedAttention(chs, chs)
        self.b10 = Block_BlancedAttention(chs, chs)
        self.b11 = Block_BlancedAttention(chs, chs)
        self.b12 = Block_BlancedAttention(chs, chs)
        self.b13 = Block_BlancedAttention(chs, chs)
        self.b14 = Block_BlancedAttention(chs, chs)
        self.b15 = Block_BlancedAttention(chs, chs)
        self.b16 = Block_BlancedAttention(chs, chs)
        self.b17 = Block_BlancedAttention(chs, chs)
        self.b18 = Block_BlancedAttention(chs, chs)
        self.b19 = Block_BlancedAttention(chs, chs)
        self.b20 = Block_BlancedAttention(chs, chs)
