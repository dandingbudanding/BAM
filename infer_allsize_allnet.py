...
if __name__ == '__main__':
    ...
    scales = [2,3,4]  #2,3,
    datasetfortests = ["Set5","Set14",   "BSDS100"]   #, "Set5","Set14",  "urban100", "BSDS100"
    networks = ["CARN_blanced_attention", "CARN_m_blanced_attention", "IMDN_BLANCED_ATTENTION","MSRN_blanced_attention","EDSR_blanced_attention",
               "AWSRN_blanced_attention", "oisr_LF_s_blanced_attention","oisr_LF_m_blanced_attention", "LWSR_blanced_attention",
                "PAN_Blanced_attention", "IMDN_ACAM", "IMDN_MSAM", "IMDN_ACAM_add_MAXpool",
               "IMDN_MSAM_add_AVGpool", "IMDN_BLANCED_ATTENTION_ADD", "IMDN_CBAM","RCAN_ori_blanced_attention","DRLN_BlancedAttention"]#"RCAN_ori_blanced_attention",
        ...
        for scale in scales:
            ...
            for network in networks:
                ...
                for i,data in enumerate(eval_dataloader):
                    ...
                    savedpath=os.path.join("./savedimg",datasetfortest,str(scale))
                    ...
                    cv2.imwrite(os.path.join(savedpath,network+"_"+str(i)+".png"),pred)
