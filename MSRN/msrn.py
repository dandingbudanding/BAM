...
class MSRN(nn.Module):
    def __init__(self, upscale, conv=common.default_conv):
...
class MSRB_blanced_attention(nn.Module):
    def __init__(self, conv=common.default_conv, n_feats=64):
...
class MSRN_blanced_attention(nn.Module):
    def __init__(self, upscale, conv=common.default_conv):
        super(MSRN_blanced_attention, self).__init__()
        ...
        for i in range(n_blocks):
            modules_body.append(
                MSRB_blanced_attention(n_feats=n_feats))
